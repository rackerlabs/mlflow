...
def _get_run_env_vars_from_context():
    """
    Returns a dictionary of environment variable key-value pairs to set in subprocess launched
    to run MLflow projects.
    """
    return {
        tracking._RUN_ID_ENV_VAR: os.environ.get(tracking._RUN_ID_ENV_VAR, None),
        tracking._TRACKING_URI_ENV_VAR: tracking.get_tracking_uri(),
        tracking._EXPERIMENT_ID_ENV_VAR: os.environ.get(tracking._EXPERIMENT_ID_ENV_VAR, None),
    }
